    ...
    return (
        ...
        >
            ...
            <section className='w-[90%] max-w-[80rem] mx-auto' data-scroll-section>
                <h1 className='text-5xl md:text-8xl mb-10 md:mb-0 font-black'>Projects</h1>
                <div className='w-fill flex flex-wrap gap-y-10 md:gap-y-[251px] md:pb-[503px]'>
                    {
                        projects.map((project, i) => (
                            ...
                            >
                                <div className='w-full aspect-video md:aspect-video shadow-xl rounded-3xl overflow-hidden'>
                                ...
                                <p className='w-full mt-1 line-clamp-2 overflow-hidden'>{project.description}</p>
                            </Link>
                        ))
                    }
                </div>
